      ...
      <Table className={classes.tableWidth} aria-label="simple table">
        <TableHead>
          <TableRow className="border__under">
            <StyledTableCell className="m2-color" align="center" width="25%">
              部位
            </StyledTableCell>
            <StyledTableCell className="m-color" align="center" width="45%">
              前回の日付
            </StyledTableCell>
            <StyledTableCell className="m2-color" align="center" width="30%">
              経過日
            </StyledTableCell>
          </TableRow>
        </TableHead>
