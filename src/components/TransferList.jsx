  ...
  return (
    <>
          ...
          <Grid item>
            <Grid container direction="column" alignItems="center">
              <div className={rightClick}>
                <SecondButton onClick={handleCheckedLeft} label={"追加する"} fullWidth={true} />
              </div>
              <div className={leftClick}>
                <SecondButton onClick={handleCheckedRight} label={"削除する"} fullWidth={true} />
              </div>
            </Grid>
          </Grid>
          <Grid item>
            <Paper className={classes.paper} id="m-height">
              <ListPaper 
                  title={<LeftPaperTitle label={dateTitle} prevdays={prevdays} nextdays={nextdays} />} 
                  handleToggle={handleToggle} 
                  items={left} 
                  checked={checked} 
                  class={'block'}
      ...
      <div className={addClass}>
        <SecondButton label={"登録する"} fullWidth={true} onClick={() => dispatch(saveDayMenus(left, date, uid, dateId))} />
      </div>
    </>
  )
}
